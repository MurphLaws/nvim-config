return {
	"hrsh7th/nvim-cmp",
	event = "VeryLazy", -- was InsertEnter; need cmp available for : cmdline
	...
	dependencies = {
		...
		"hrsh7th/cmp-nvim-lua", -- ✅ :lua / vim.api completion
		{
			"L3MON4D3/LuaSnip",
			version = "v2.*",
	...
	config = function()
		...
		cmp.setup({
			enabled = function()
				...
				return mode == "i" or mode == "c" -- ✅ allow cmp in command-line mode
			end,
			experimental = {
				ghost_text = false,
			},
